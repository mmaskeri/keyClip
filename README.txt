...
--- Functionality with ChemDraw 20 and Big Sur are currently uncertain. ---
...
3. Open Terminal, type "sudo chmod +x ~/Library/Scripts/keyClip6.sh"
    - enter your password
...
5. Give Accessibility privileges to Automator
